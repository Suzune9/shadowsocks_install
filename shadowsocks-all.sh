...
shadowsocks_r_file="shadowsocksr-3.1.2"
shadowsocks_r_url="https://github.com/Suzune9/shadowsocksr/archive/3.1.2.tar.gz"
shadowsocks_r_init="/etc/init.d/shadowsocks-r"
shadowsocks_r_config="/etc/shadowsocks-r/config.json"
shadowsocks_r_centos="https://github.com/Suzune9/shadowsocks_install/blob/master/shadowsocksR"
shadowsocks_r_debian=https://github.com/Suzune9/shadowsocks_install/blob/master/shadowsocksR-debian"
